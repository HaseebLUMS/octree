...
set_target_properties(avif PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libavif.16.0.1.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libavif.16.dylib"
  )

list(APPEND _cmake_import_check_targets avif )
list(APPEND _cmake_import_check_files_for_avif "${_IMPORT_PREFIX}/lib/libavif.16.0.1.dylib" )
